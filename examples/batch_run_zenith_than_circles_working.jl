...
function run_zenith_circles(;
    ...
    apply_geom_adjustments!(sys, V3GeomAdjustConfig(
        reduce_te=true, reduce_tip=true))
    if kcu_mass !== nothing
    ...
    # Build log naming once so failures can still save partial data.
...
# elevation_vals = [15]
# g_earth_vals = [0.0]
# us_vals = [0.05, 0.075, 0.1, 0.125, 0.15, 0.175, 0.2]
# up_vals = [0.42]
# vw_vals = [7.6]
# lt_vals = [271]
# # kcu_mass_2019 = 22.0
...
#     us_vals, up_vals, vw_vals, lt_vals, kcu_mass_vals)))
# @info "2025 Batch (1) completed" total = n_total failed = length(failed_runs)

# # =============================================================================
# # Batch sweep 2: 2019 kite parameters
# # =============================================================================

elevation_vals = [50]
g_earth_vals = [0.0]
# us_vals = [0.05, 0.1, 0.15, 0.2, 0.25, 0.3, 0.35]
us_vals = [0.1]
up_vals = [0.35]
vw_vals = [8.4]
lt_vals = [269]
...
n_total = length(collect(Iterators.product(
    elevation_vals, g_earth_vals,
    us_vals, up_vals, vw_vals, lt_vals, kcu_mass_vals)))
@info "2019 Batch (2) completed" total = n_total failed = length(failed_runs)
